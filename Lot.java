...
public class Lot {
    ...
    public void setEtatLottxt(String etatLottxt) {
      
        int codeEtat=0;
        
        switch(codeEtat){
            case 1: etatLottxt = "Lancé";
              break;
            case 2: etatLottxt = "Démarré";
              break;
            case 3: etatLottxt = "Libéré";
              break;
            default: etatLottxt = "Arrêté";
      }
    }
